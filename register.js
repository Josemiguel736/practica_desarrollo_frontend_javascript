...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const { showNotification: showBigNotification } = notificationController(
  ...
  const { showNotification: showEmailNotification } =
    notificationController(emailContainer);
  const { showNotification: showPassotification } =
    notificationController(passContainer);
